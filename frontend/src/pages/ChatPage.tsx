  ...
  return (
    <>
      ...
      <div className="chat-layout">
        ...
        {/* 右侧：执行轨迹 (加大占比) */}
        <div className="right-panel execution-only">
          <div className="execution-panel">
            ...
            {state.executionLog.length === 0 ? (
              ...
              <div className="execution-track-grid">
                {state.executionLog.map((entry, i) => (
                  <div key={i} className={`execution-step ${entry.status}`}>
                    ...
                    <div className="execution-content">
                      <div className="execution-node">{entry.node}</div>
                      <div className="execution-detail">{entry.detail}</div>
                    </div>
                  </div>
                ))}
              </div>
